...
tokens = [
    ...
    ["ALIGNOF",          r"alignof",                     def_undef],
    ["AUTO",             r"auto",                        def_undef],
    ["BREAK",            r"break",                       def_undef],
    ["CASE",             r"case",                        def_undef],
    ["CHAR",             r"char",                        def_undef],
    ["CONST",            r"const",                       def_undef],
    ["COUNTINUE",        r"countinue",                   def_undef],
    ["DEFAULT",          r"default",                     def_undef],
    ["DO",               r"do",                          def_undef],
    ["ELSE",             r"else",                        def_undef],
    ["ENUM",             r"enum",                        def_undef],
    ["EXTERN",           r"extern",                      def_undef],
    ["FALSE",            r"false",                       def_undef],
    ["FLOAT",            r"float",                       def_undef],
    ["FOR",              r"for",                         def_undef],
    ["GOTO",             r"goto",                        def_undef],
    ["IF",               r"if",                          def_undef],
    ["INLINE",           r"inline",                      def_undef],
    ["INT",              r"int",                         def_undef],
    ["LONG",             r"long",                        def_undef],
    ["RETURN",           r"return",                      def_undef],
    ["SHORT",            r"short",                       def_undef],
    ["SIGNED",           r"signed",                      def_undef],
    ["SIZEOF",           r"sizeof",                      def_undef],
    ["STRUCT",           r"struct",                      def_undef],
    ["SWITCH",           r"switch",                      def_undef],
    ["TYPEDEF",          r"typedef",                     def_undef],
    ["UNION",            r"union",                       def_undef],
    ["UNSIGNED",         r"unsigned",                    def_undef],
    ["VOID",             r"void",                        def_undef],
    ["WHILE",            r"while",                       def_undef],
    ["PLUS",             r"\+",                          set()],
    ["MINUS",            r"-",                           set()],
    ["STAR",             r"\*",                          set()],
    ["SLASH",            r"/",                           set()],
