...
|19|addg|r r num64|сложить значение второго регистра и числа, и записать результат в первый, если CARRY и ZERO выключены|
|1a|addo|r r num64|сложить значение второго регистра и числа, и записать результат в первый, если включен флаг OVERFLOW|
|1b|addno|r r num64|сложить значение второго регистра и числа, и записать результат в первый, если выключен флаг OVERFLOW|
|1c|pushl|r||
|1d|pushi|r||
|1e|pushs|r||
|1f|pushb|r||
