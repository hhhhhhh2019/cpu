...
|ZERO|1||
|CARRY|2||
|SIGN|4|знак результата при вычитании|
...
|14|sdiv|r r num64||
|15|cmp|r num64||
|16|adde|r r num64|сложить значение второго регистра и числа, и записать результат в первый, если включен флаг ZERO|
|17|addne|r r num64|сложить значение второго регистра и числа, и записать результат в первый, если выключен флаг ZERO|
|18|addl|r r num64|сложить значение второго регистра и числа, и записать результат в первый, если включен флаг CARRY|
|19|addg|r r num64|сложить значение второго регистра и числа, и записать результат в первый, если флаги CARRY и ZERO выключены|
|1a|addsl|r r num64|сложить значение второго регистра и числа, и записать результат в первый, если флаг включен SIGN|
|1b|addsg|r r num64|сложить значение второго регистра и числа, и записать результат в первый, если флаги SIGN и ZERO выключены|
|1c|pushl|r||
|1d|pushi|r||
|1e|pushs|r||
|1f|pushb|r||
...
|3a|cint|num8 num8|вызов прерывания на другом ядре|
