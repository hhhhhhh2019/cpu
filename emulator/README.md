...
|14|sdiv|r r num64||
|15|cmp|r num64||
|16|adde|r r num64|сложить значение второго регистра и числа, и записать резьтат в первый, если включен флаг ZERO|
|17|addne|r r num64|сложить значение второго регистра и числа, и записать резьтат в первый, если выключен флаг ZERO|
|18|addl|r r num64|сложить значение второго регистра и числа, и записать резьтат в первый, если включен флаг CARRY|
|19|addg|r r num64|сложить значение второго регистра и числа, и записать резьтат в первый, если CARRY и ZERO выключены|
|1a|addo|r r num64|сложить значение второго регистра и числа, и записать резьтат в первый, если включен флаг OVERFLOW|
|1b|addno|r r num64|сложить значение второго регистра и числа, и записать резьтат в первый, если выключен флаг OVERFLOW|
|1c|pushl|r||
|1d|pushi|r||
|1e|pushs|r||
|1f|pushb|r||
